(() => {
  ...
  const LOAD_CARRIER_CATALOG = Object.freeze({
    loose: Object.freeze({id: 'loose', name: 'Lose Ware', tareKg: 0, footprintM2: 0, depositValue: 0, baseHandlingMinutes: 10, loadingMinutesPerCarrier: 0, unloadingMinutesPerCarrier: 0}),
    'euro-pallet': Object.freeze({id: 'euro-pallet', name: 'Europalette', tareKg: 25, footprintM2: 0.96, depositValue: 25, baseHandlingMinutes: 10, loadingMinutesPerCarrier: 3, unloadingMinutesPerCarrier: 2}),
    'industrial-pallet': Object.freeze({id: 'industrial-pallet', name: 'Industriepalette', tareKg: 30, footprintM2: 1.2, depositValue: 30, baseHandlingMinutes: 12, loadingMinutesPerCarrier: 4, unloadingMinutesPerCarrier: 3}),
